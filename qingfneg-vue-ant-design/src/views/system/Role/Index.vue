  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div style="margin: 0 0 10px 0">
        <a-space size="small">
          <a-button v-if="authButton.includes('role:add')" @click="add()"
            >添加</a-button
          >
          <a-button
            v-if="authButton.includes('role:edit')"
            type="primary"
            @click="edits()"
            >编辑</a-button
          >
          <a-button
            v-if="authButton.includes('role:del')"
            type="danger"
            @click="dels()"
            >删除</a-button
          >
          <a-button
            v-if="authButton.includes('role:assignAuth')"
            type="primary"
            @click="auths()"
            >分配权限</a-button
          >
          <a-button
            v-if="authButton.includes('role:download')"
            @click="download()"
            >下载</a-button
          >
        </a-space>
        ...
        <template slot="operation" slot-scope="text, record, index">
          <div class="editable-row-operations">
            <a-space size="small">
              <a-button
                size="small"
                v-if="authButton.includes('role:info')"
                @click="() => info(record)"
                >详情</a-button
              >
              <a-button
                size="small"
                type="primary"
                v-if="authButton.includes('role:edit') && authOpera(record)"
                @click="() => edit(record)"
                >编辑</a-button
              >
              <a-button
                size="small"
                type="danger"
                v-if="authButton.includes('role:del') && authOpera(record)"
                @click="() => del(record.id)"
                >删除</a-button
              >
              <a-button
              ...
              <a-button
                size="small"
                type="danger"
                v-if="authButton.includes('role:status')"
