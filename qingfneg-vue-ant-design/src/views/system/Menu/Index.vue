      ...
      <a-col :md="24" :lg="18">
        <a-card :bordered="false">
          ...
          <div style="margin: 0 0 10px 0">
            <a-space size="small">
              <a-button v-if="authButton.includes('menu:add')" @click="add()"
                >添加</a-button
              >
              <a-button
                v-if="authButton.includes('menu:edit')"
                type="primary"
                @click="edits()"
                >编辑</a-button
              >
              <a-button
                v-if="authButton.includes('menu:del')"
                type="danger"
                @click="dels()"
                >删除</a-button
              >
            ...
            <template slot="operation" slot-scope="text, record, index">
              <div class="editable-row-operations">
                <a-space size="small">
                  <a-button
                    size="small"
                    v-if="authButton.includes('menu:info')"
                    @click="() => info(record)"
                    >详情</a-button
                  >
                  <a-button
                    size="small"
                    type="primary"
                    v-if="authButton.includes('menu:edit') && authOpera(record)"
                    @click="() => edit(record)"
                    >编辑</a-button
                  >
                  <a-button
                    size="small"
                    type="danger"
                    v-if="authButton.includes('menu:del') && authOpera(record)"
                    @click="() => del(record.id)"
                    >删除</a-button
                  >
                  <a-button
                    size="small"
                    type="danger"
                    v-if="authButton.includes('menu:status')"
