...
export default {
  ...
  methods: {
    ...
    getTreeList(params) {
      getTreeList({level_num:2,...params}).then((response) => {
        ...
        this.$emit(
          ...
          treeData[0].id,
          treeData[0].name,
          treeData[0].area_cascade + ":" + treeData[0].level_num
        );
      });
    },
    fommat({
      ...
      childrenStr = "children",
       ...
       arrayList.push({'name':'地区信息','id':'0','parent_id':'1','area_cascade':'area_1_','level_num':'0'})
