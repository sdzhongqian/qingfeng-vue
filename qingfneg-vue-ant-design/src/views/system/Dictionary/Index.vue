      ...
      <a-col :md="24" :lg="18">
        <a-card :bordered="false">
          ...
          <div style="margin: 0 0 10px 0">
            <a-space size="small">
              <a-button
                v-if="authButton.includes('dictionary:add')"
                @click="add()"
                >添加</a-button
              >
              <a-button
                v-if="authButton.includes('dictionary:edit')"
                type="primary"
                @click="edits()"
                >编辑</a-button
              >
              <a-button
                v-if="authButton.includes('dictionary:del')"
                type="danger"
                @click="dels()"
                >删除</a-button
              >
              <a-button
                v-if="authButton.includes('dictionary:download')"
                @click="download()"
                >下载</a-button
              >
            </a-space>
            ...
            <template slot="operation" slot-scope="text, record, index">
              <div class="editable-row-operations">
                <a-space size="small">
                  <a-button
                    size="small"
                    v-if="authButton.includes('dictionary:info')"
                    @click="() => info(record)"
                    >详情</a-button
                  >
                  <a-button
                    ...
                    type="primary"
                    v-if="
                      authButton.includes('dictionary:edit') &&
                      authOpera(record)
                    "
                    @click="() => edit(record)"
                    >编辑</a-button
                  ...
                  <a-button
                    ...
                    type="danger"
                    v-if="
                      authButton.includes('dictionary:del') && authOpera(record)
                    "
                    @click="() => del(record.id)"
                    >删除</a-button
                  >
                  <a-button
                    size="small"
                    type="danger"
                    v-if="authButton.includes('dictionary:status')"
